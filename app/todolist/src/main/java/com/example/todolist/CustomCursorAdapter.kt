...
import com.example.todolist.CustomCursorAdapter.TaskViewHolder
 ...
 */
abstract class CustomCursorAdapter
/**
 ...
 */(private val mContext: Context) :
   ...
   override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        val priorityCircle =
            holder.priorityView.getBackground() as GradientDrawable
    ...
    */
    ...
    inner class TaskViewHolder(itemView: View) :
        ...
        init {
            taskDescriptionView =
                itemView.findViewById<View>(R.id.taskDescription) as TextView
            priorityView =
                itemView.findViewById<View>(R.id.priorityTextView) as TextView
        }
    }
