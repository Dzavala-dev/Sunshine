...
class TestTaskContentProvider {
    ...
    fun testProviderRegistry() {
        ...
        val taskProviderClassName: String = TaskContentProvider::class.java.getName()
        ...
        try {
            ...
            val providerNotRegisteredAtAll =
                "Error: TaskContentProvider not registered at " + mContext.packageName
            /*
             * This exception is thrown if the ContentProvider hasn't been registered with the
             * manifest at all. If this is the case, you need to double check your
             * AndroidManifest file
             */Assert.fail(providerNotRegisteredAtAll)
        }
    } //================================================================================
    // Test UriMatcher
    //================================================================================
