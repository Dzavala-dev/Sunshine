...
object ReminderUtilities {
    ...
    private val REMINDER_INTERVAL_SECONDS =
        TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_MINUTES.toLong()).toInt()
    ...
    @Synchronized
    fun scheduleChargingReminder(@NonNull context: Context?) {
        ...
        val constraintReminderJob =
            dispatcher.newJobBuilder() /* The Service that will be used to write to preferences */
        ...
        /* Schedule the Job with the dispatcher */dispatcher.schedule(constraintReminderJob)

        /* The job has been initialized */sInitialized = true
    }
}
