...
object SunshineDateUtils {
    ...
    fun getFriendlyDateString(
         ...
         * 00:00 GMT)
         */
        val daysFromEpochToProvidedDate =
            elapsedDaysSinceEpoch(localDate)

        /*
         * As a basis for comparison, we use the number of days that have passed from the epoch
         * until today.
         */
        val daysFromEpochToToday =
        ...
        return if (daysFromEpochToProvidedDate == daysFromEpochToToday || showFullDate) {
            ...
            if (daysFromEpochToProvidedDate - daysFromEpochToToday < 2) {
                ...
                val localizedDayName =
                    SimpleDateFormat("EEEE").format(localDate)
     ...
     */
    private fun getReadableDateString(
        context: Context,
        timeInMillis: Long
    ): String {
        val flags = (DateUtils.FORMAT_SHOW_DATE
