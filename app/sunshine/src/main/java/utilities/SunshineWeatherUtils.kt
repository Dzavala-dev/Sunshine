...
class SunshineWeatherUtils {
    ...
    fun formatHighLows(
        ...
        val formattedHigh: String =
            SunshineWeatherUtils.formatTemperature(context, roundedHigh.toDouble())
        val formattedLow: String =
            SunshineWeatherUtils.formatTemperature(context, roundedLow.toDouble())
    ...
    fun getStringForWeatherCondition(
        ...
        val stringId: Int
        stringId = if (weatherId >= 200 && weatherId <= 232) {
    ...
    fun getArtResourceForWeatherCondition(weatherId: Int): Int {
        ...
        Log.e(SunshineWeatherUtils.LOG_TAG, "Unknown Weather: $weatherId")
        return R.drawable.art_storm
    }
}