...
import com.example.android.sunshine.utilities.SunshineDateUtils.getFriendlyDateString
import com.example.android.sunshine.utilities.SunshineDateUtils.getUTCDateFromLocal
import com.example.android.sunshine.utilities.SunshineDateUtils.normalizeDate
...
class OpenWeatherJsonUtils {
    ...
    fun getSimpleWeatherStringsFromJson(
        ...
        val utcDate =
            getUTCDateFromLocal(localDate)
        val startDay =
            normalizeDate(utcDate)
        for (i in 0 until weatherArray.length()) {
             ...
             */dateTimeMillis =
                startDay + SunshineDateUtils.DAY_IN_MILLIS * i
            date = getFriendlyDateString(
                context!!,
                dateTimeMillis,
                false
            )
