...
object NotificationUtils {
     ...
     */
    val WEATHER_NOTIFICATION_PROJECTION = arrayOf<String>(
     ...
     */
    const val INDEX_WEATHER_ID = 0
    const val INDEX_MAX_TEMP = 1
    const val INDEX_MIN_TEMP = 2
    ...
    fun notifyUserOfNewWeather(context: Context) {
        ...
        val todaysWeatherUri: Uri = WeatherContract.WeatherEntry
         ...
         */if (todayWeatherCursor!!.moveToFirst()) {
            ...
            val notificationText =
                getNotificationText(context, weatherId, high, low)
             ...
             */SunshinePreferences.saveLastNotificationTime(
                context,
                System.currentTimeMillis()
            )
        }

        /* Always close your cursor when you're done with it to avoid wasting resources. */todayWeatherCursor.close()
    }
