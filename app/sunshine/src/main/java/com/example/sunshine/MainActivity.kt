...
abstract class MainActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* setLayoutManager associates the LayoutManager we created above with our RecyclerView */mRecyclerView!!.layoutManager =
            layoutManager
    ...
    private fun showWeatherDataView() {
        ...
        /* Finally, make sure the weather data is visible */mRecyclerView!!.visibility =
            View.VISIBLE
    }
